...
Getting Started
Clone the repo:
git clone https://github.com/<org>/team-5.git
cd team-5
Confirm you have push access under the dev5 team. If not, ping a team lead or organizer.
Set up the project locally per the instructions in README.md.
